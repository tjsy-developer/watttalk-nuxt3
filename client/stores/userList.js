...
export const useUserListStore = defineStore('userList', {
  ...
  actions: {
    ...
    add(payload) { // Added type hint for payload
      ...
      this.userListAll.connectingstatus[payload.idx] = payload.json.connectingstatus;
    ...
    setNotification(payload) { // Added type hint for payload
      if (payload.type === 1) {
